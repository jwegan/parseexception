...
public class ViewSolutionsSubmittedByFriendsAction extends BaseAction {
	public ViewSolutionsSubmittedByFriendsAction()
	{
		super();
	}
	...
	/**
	 ...
	 {	 
		 ...
		 ReturnList<Solution> results =
			 DBQueries.getSolutionsSubmittedByFriends(curUser.getUid(), pageNum);
		 ...
		 request.setAttribute("solutions", likedSolutions);
	 	 ...
	 	 request.setAttribute("actionURL", "/submittedbyfriends");
