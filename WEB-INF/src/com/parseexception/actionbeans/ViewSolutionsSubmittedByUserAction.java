...
public class ViewSolutionsSubmittedByUserAction extends BaseAction{
	public ViewSolutionsSubmittedByUserAction()
	{
		super();
	}
	 ...
	 {	 
		 ...
		 ReturnList<Solution> results = u.getSubmittedSolutions(pageNum, curUser, request.getParameter("tag"));
		 ...
		 request.setAttribute("solutions", likedSolutions);
	 	 ...
	 	 request.setAttribute("actionURL", "/submittedbyuser" + param);
